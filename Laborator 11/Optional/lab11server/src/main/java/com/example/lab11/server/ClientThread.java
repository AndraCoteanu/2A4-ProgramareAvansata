...
import com.example.lab11.controllers.FriendController;
import com.example.lab11.controllers.UserController;
                ...
                if (request == null) {
                    ...
                    for (int i = 1; i < tokens.length; i++) {
                        ...
                        for (int j = 0; j < users.get(idClient).friends.size(); j++) {
                            if (users.get(idClient).friends.get(j).equals(tokens[i])) {
                                okFriendExists = 1;
                            }
                        }
